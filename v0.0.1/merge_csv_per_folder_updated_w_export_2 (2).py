...
if not all_dfs:
    ...
    duplicate_row_count = row_count_before_merge - len(merged_df)
...
# Transpose for column-wise comparison and keep the last occurrence of duplicates
merged_df = merged_df.loc[:, ~merged_df.T.duplicated(keep='last')]
...
desired_folder_path = "C:\\Users\\pingk\\OneDrive - Chulalongkorn University\\Documents\\mekargit\\zaytalnakhil-1\\Kerjaan\\hasilmentah"  # Replace with your actual target path
